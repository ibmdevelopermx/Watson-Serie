...
const SENTIMENT_TERM_ITEM = 'Todos los Términos';   // used to indicate no specific item is seleced
const TRENDING_TERM_ITEM = 'Seleccionar Término';  // used to indicate no specific item is seleced

// filter types and strings to use
const filterTypes = [
  { key: ENTITY_FILTER,       value: ENTITY_FILTER,      text: 'Entidades'},
  { key: CATEGORY_FILTER,     value: CATEGORY_FILTER,    text: 'Categorías'},
  { key: CONCEPT_FILTER,      value: CONCEPT_FILTER,     text: 'Conceptos'},
  { key: KEYWORD_FILTER,      value: KEYWORD_FILTER,     text: 'Palabras Clave'},
  { key: ENTITY_TYPE_FILTER,  value: ENTITY_TYPE_FILTER, text: 'Tipos de Entidades'} ];
...
const sortKeys = [
  ...
  { type: 'LOWEST', 
    sortBy: 'result_metadata.score', 
    sortByInt: 'score',
    text:  'Puntaje Más Bajo' },
  { type: 'NEWEST', 
    sortBy: '-date', 
    sortByInt: '-date',
    text: 'Primero los más recientes' },
  { type: 'OLDEST', 
    sortBy: 'date', 
    sortByInt: 'date',
    text: 'Primero los más antiguos' },
  { type: 'BEST', 
