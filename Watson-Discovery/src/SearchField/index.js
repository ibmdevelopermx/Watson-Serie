      ...
      <Grid className='search-field-grid'>
        <Grid.Column width={12} verticalAlign='middle' textAlign='center'>
          <Header as='h1' textAlign='center'>
            Reseñas de la pizzería "Las pizzas del perro negro"
          </Header>
          <Input
            className='searchinput'
            icon='search'
            placeholder='Ingrese la cadena de búsqueda'
        ...
        <Grid.Column width={4} verticalAlign='top' textAlign='left'>
          <Grid.Row>
            <Checkbox 
              label='Búsqueda de lenguaje natural' 
          ...
          <Grid.Row>
            <Checkbox 
              label='Limitar a cien resultados'
